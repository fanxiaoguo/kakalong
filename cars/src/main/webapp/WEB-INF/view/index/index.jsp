...
<div class="container">
    <div class="logo">
        <a href="./index.html">逆时光网咖后台</a></div>
    <div class="left_open">
        ...
        <ul id="nav">
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a onclick="xadmin.add_tab('权限管理(静态表格)','power/toPower.do')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>权限管理(静态表格)</cite></a>
                    </li>
                </ul>
            </li>
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a onclick="xadmin.add_tab('品牌列表','order-list.html')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>品牌列表</cite></a>
                    </li>
                </ul>
